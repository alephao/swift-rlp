...
public struct RLPDecoder: Sendable {
...
enum DecodingLengthType: Sendable {
  case string
  case array
}
...
func decodeLength(_ input: Data) throws(RLPDecoder.Error) -> (
  offset: Int, size: Int, DecodingLengthType
) {
